...
class LoadingDialog(private val context: Context) {
    ...
    fun show() {
        ...
        // 获取整个布局
        val layout = view.findViewById<LinearLayout>(R.id.base_dialog_view)
        // 页面中的LoadingView
        ...
        mLoadingDialog?.let {
            ...
            it.setCanceledOnTouchOutside(cancelout)
            it.setContentView(layout, LinearLayout.LayoutParams(
