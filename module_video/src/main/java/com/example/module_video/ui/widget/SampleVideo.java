...
public class SampleVideo extends StandardGSYVideoPlayer {
    ...
    private void initView() {
        mMoreScale = findViewById(R.id.moreScale1);
        mSwitchSize = findViewById(R.id.switchSize1);
        mChangeRotate = findViewById(R.id.change_rotate1);
        mChangeTransform = findViewById(R.id.change_transform1);
